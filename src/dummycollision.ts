...
export interface IDummyCollision extends ICollision {
  date_time: number;
  x: number;
  y: number;
  location: string;
...
export class DummyCollision extends Collision implements IDummyCollision {
  [index: string]: any;
  constructor(collision?: DummyCollision) {
